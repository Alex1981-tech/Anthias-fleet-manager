        ...
        <div className="modal-content">
          ...
          <form onSubmit={handleSubmit}>
            <div className="modal-body">
                ...
                {cameras.map((cam, i) => (
                  ...
                  >
                    ...
                    <input
                      ...
                      placeholder={t('cctv.cameraUrlPlaceholder')}
                      required
                    />
                    <button
                      type="button"
              ...
              {/* Credentials */}
              <div className="mb-3">
                <label className="form-label">{t('cctv.credentials')}</label>
                <div className="row g-2">
                  ...
                  <div className="col-6">
                    <input
                      ...
                      placeholder={config ? t('cctv.passwordHint') : t('cctv.password')}
                    />
                  </div>
                </div>
              </div>
            ...
            <div className="modal-footer">
              ...
              <button
                ...
                disabled={saving || !name.trim() || validCameraCount === 0}
              >
